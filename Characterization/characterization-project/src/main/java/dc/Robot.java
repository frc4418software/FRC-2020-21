...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    // create left motor
    WPI_TalonSRX leftMotor = setupWPI_TalonSRX(10, Sides.LEFT, false);

    WPI_TalonSRX leftFollowerID11 = setupWPI_TalonSRX(11, Sides.FOLLOWER, false);
    leftFollowerID11.follow(leftMotor);

    WPI_TalonSRX rightMotor = setupWPI_TalonSRX(20, Sides.RIGHT, true);
    WPI_TalonSRX rightFollowerID21 = setupWPI_TalonSRX(21, Sides.FOLLOWER, true);    
    rightFollowerID21.follow(rightMotor);
